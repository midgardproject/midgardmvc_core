 ...
 * @package midgardmvc_core
 */
class midgardmvc_core_services_authorization_simple implements midgardmvc_core_services_authorization
{
    private $sudo = false;
    ...
    private function connect_to_signals()
    {
        $this->_core->observation->add_listener
        (
